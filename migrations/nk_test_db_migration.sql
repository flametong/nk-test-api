...
-- Дамп структуры базы данных nk_test
DROP DATABASE IF EXISTS `nk_test`;
CREATE DATABASE IF NOT EXISTS `nk_test` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `nk_test`;

-- Дамп структуры для таблица nk_test.categories
...
-- Дамп данных таблицы nk_test.categories: ~5 rows (приблизительно)
...
-- Дамп структуры для таблица nk_test.goods
...
-- Дамп данных таблицы nk_test.goods: ~9 rows (приблизительно)
...
INSERT INTO `goods` (`id`, `title`, `inn`, `barcode`, `description`, `price`) VALUES
	...
	(16, 'Bun', '8743013914', '2280024701003', 'Bun description', 59.90),
	...
	(23, 'Milk', '8223013901', '2113324701011', 'Milk description', 69.90);
/*!40000 ALTER TABLE `goods` ENABLE KEYS */;

-- Дамп структуры для таблица nk_test.goods_categories
...
-- Дамп данных таблицы nk_test.goods_categories: ~12 rows (приблизительно)
